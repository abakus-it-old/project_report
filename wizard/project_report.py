...
class project_report(models.Model):
    ...
    tasks_order = fields.Selection([('create_date DESC', 'Creation date'), ('stage_id','Stage'),('name ASC', 'Name')], string="Order by", default='create_date DESC')
    ...
    issues_order = fields.Selection([('create_date DESC', 'Creation date'), ('stage_id','Stage'),('name ASC', 'Name')], string="Order by", default='create_date DESC')
